...
Public Class frmMatDisciplinas
    ...
    Dim objFicha As New clsMatDisciplina
    ...
    Private Sub frmMatDisciplina_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        objFicha.subLoad()
    ...
    Private Sub cmbDisciplina_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles cmbDisciplina.Validating
        e.Cancel = objFicha.SubValida(cmbDisciplina)
    End Sub
